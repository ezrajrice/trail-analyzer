...
$(document).ready(function() {
    ...
    //This "require" function is used by the ESRI/DOJO system. It loads modules and then runs the "function" code
 	...
 	function(ArcGISTiledMapServiceLayer, FeatureLayer, Map, Query, Circle, esriLang, parser){
        ...
        var geoprocessing_url = "http://geoserver.byu.edu:6080/arcgis/rest/services/Ellie_Ott/hiking/GPServer/hiking/execute?" +
            "ID_input=[[TRAIL_ID]]&env%3AoutSR=&env%3AprocessSR=&returnZ=true&returnM=true&f=json";
        ...
        map.on("click", function(evt){
            ...
            var ajax_url = geoprocessing_url.replace('[[TRAIL_ID]]', selectedTrail.attributes.TrailID);
            ...
            $.ajax({
                ...
                success : function(data) {
                    ...
                    var test_data = [120, 140, 128, 147, 148, 153, 160];
                    var plot_data = [];
